  ...
  return (
    <Flex direction="column" p="10px" gap={5}>
      ...
      <form id="filter-form" onSubmit={handleSubmit(onSubmit)}>
        <FormControl>
          <FormLabel htmlFor="primarySector">Sector</FormLabel>
          ...
          <FormLabel htmlFor="subsector">Sub-sector</FormLabel>
          ...
          <FormLabel htmlFor="maxHarmScore">Maximum Harm Score</FormLabel>
          <NumberInput id="maxHarmScore" step={1} defaultValue={7} min={3} max={15} {...register('maxHarmScore')}>
            <NumberInputField />
            <NumberInputStepper>
              <NumberIncrementStepper />
              <NumberDecrementStepper />
          ...
          <FormLabel htmlFor="minHarmScore">Minimum Harm Score</FormLabel>
          <NumberInput id="minHarmScore" step={1} defaultValue={3} min={3} max={15} {...register('minHarmScore')}>
            <NumberInputField />
            <NumberInputStepper>
              <NumberIncrementStepper />
              <NumberDecrementStepper />
